...
<html>
    <head>
        ...
        <title>Satellite | CV</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Sơ yếu lí lịch của Đoàn Đức Tín">
        ...
        <link rel="stylesheet" href="Resource/css/fancybox.min.css">
        <link rel="stylesheet" href="Resource/css/bootstrap.css">
        <link rel="stylesheet" href="Resource/css/style.css">
    </head>
    <body>  
        <br>
        <h2 style="font-family: arial,serif;color:orange;text-align: center;">Last Update: 09/05/2019</h2>
        <img src="Resource/img/cv.png" class="img-fluid" alt="satellite1012_updateIn_9_5_19">
        <br>
        <p style="margin-bottom: 0;padding-bottom: 0;display: inline-block; color:white;position: absolute;right:0; background-color:black;font-size: 22px;text-align: right;"> Satellite | satellite1012</p>
