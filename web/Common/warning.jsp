...
<head>
    ...
    <meta name="description" content="Cảnh báo bảo mật">
            ...
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-11">
                        ...
                        <h2 class="heading mb-5">BLOCKED</h2>
                        <h5 class="heading mb-4" style="font-weight:700;color:orange;font-size:35px;">Đường dẫn không chính xác hoặc bạn không đủ quyền thực hiện thao tác này</h5>
                        <br>
                        <a href="http://satellite-fpt.azurewebsites.net/" style="font-weight:600;font-size:22px;">
                            Vui lòng quay lại trang chủ, và thử lại sau</a>
                        <br><br><br><br><br>
                    </div>
                </div>
            </div>
    ...
    function ShowLog_Document() {
        Swal.fire({
            ...
            html: "<span style=\"color:orangered\">Tài liệu xuất phát từ đâu?</span><br>" +
                ...
                "<li> Không nên xóa tên tác giả, không nên chép 100%</li><br>" +
                "<li> Tài liệu được thêm mới thường xuyên nên nếu bạn nào tải hết về một lượt, lỗ ráng chịu</li><br>" +
                "<li> Mình sẽ kiểm tra database thường xuyên và bạn nào hết stone mình sẽ bơm thêm hên xui :)))</li><br><br><br> Cảm ơn các bạn đã đọc<br>" +
