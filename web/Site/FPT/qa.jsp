    ...
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center text-center">
            ...
            <div id="search-section" class="search" style="width:80%;background: white;padding: 10px">
                    ...
                    <label for="searchBoxInput"></label><input style="border: 1px solid" id="searchBoxInput" type="text" placeholder="Tìm kiếm tiêu đề câu hỏi" onkeyup="searchQA()">
...
<script>
    ...
    function previewFile() {
        ...
        reader1.addEventListener("load", function () {
            document.getElementById("imgBase64").value = reader1.result;
